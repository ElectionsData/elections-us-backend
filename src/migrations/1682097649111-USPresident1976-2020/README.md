This migration transfers data from the file `1682097649111-USPresident1976-2020.csv` to a database

#Codebook for U.S. President Returns 1976–2020

The data file `1682097649111-USPresident1976-2020.csv` contains constituency (state-level) returns for elections to the U.S. presidency from 1976 to 2020.  The data source is the document "[Statistics of the Congressional Election](http://history.house.gov/Institution/Election-Statistics/Election-Statistics/)," published biennially by the Clerk of the U.S. House of Representatives.
